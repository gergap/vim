" Vim syntax file
" Language: C++
" Original Author: Dieter Hartmann
" from: https://github.com/Townk/vim-qt/blob/master/after/syntax/cpp.vim
" Modified by: Gerhard Gappmeier
" License: GPL

" --- Qt classes
syn keyword qClass QAccel QDict QIconFactory QPicture QSyntaxHighlighter
syn keyword qClass QAccessible QDictIterator QIconSet QPixmap Qt QIcon
...
" --- Qt keywords
"
syn keyword cType SIGNAL SLOT connect tr
